...
brandConfig.matchNetAfterDirectConn_AC && supportAddDeviceMode.push('air_conditioning_bluetooth_connection', 'air_conditioning_bluetooth_connection_network')
brandConfig.matchNetAfterDirectConn_WB01 && supportAddDeviceMode.push('WB01_bluetooth_connection', 'WB01_bluetooth_connection_network')
...
const addDeviceACList = {
  white: [ // 注释数字遥控器蓝牙直连功能 Yoram 930
    ...
    // '22013169', // KFR-KS1-1P 
    // '22013181',
    // '22013183', // KFR-26GW/N8MXC1-J1  
    // '22020105', // KFR-50G/N10-1,
    // '220F1241', 
    // '220F1239', // KFR-35G/N8XY1-P1
    // '22013177',
    // '22013179', // KFR-35G/N8PD1-1
    // '220F1249',
    // '220F1247',
    // '220F1257',
    // '220F1255',
    ...
    // '220F1251',
    // '220F1261',
    // '220F1259', // KFR M1_1_BLE
    // '220Z1636',
    // '22013171',
    // '22013173', // KFR-35G/JH2-1 
    // '22251671',
    // '222Z1642',
    // '22251673', // FQ1-1
...
const addDeviceSDK = {
    ...
    return new Promise((resolve, reject) => {
      requestService
        ...
        .then((res) => {
          ...
          console.log('res====', res)
          resolve({
            mode: res.data.data[netWorking].mainConnectinfoList[0].mode,
            guideInfo: res.data.data[netWorking].mainConnectinfoList[0],
          })
        })
        .catch((err) => {
  ...
  //判断是否是设备ap
  isDeviceAp(ssid) {
    let reg = /(midea|bugu|toshiba|colmo)_[a-z0-9]{2}_.{4}/
