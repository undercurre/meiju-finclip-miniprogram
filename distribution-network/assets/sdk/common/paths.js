module.exports = {
    ...
    reLinkCombined: '/distribution-network/addDevice/pages/reLinkCombined/reLinkCombined', // 离线重连页面
    gatewayList: '/distribution-network/addDevice/pages/gatewayList/gatewayList',
    gatewaySearch: '/distribution-network/addDevice/pages/gatewaySearch/gatewaySearch',
    afterCheck: '/distribution-network/addDevice/pages/afterCheck/afterCheck',
    //登录页面
    ...
    //插件前缀，新架构
    newPluginUrl: '/src/modules/module_plugin',
    //插件前缀，旧逻辑
    PluginUrl: '/plugin',
