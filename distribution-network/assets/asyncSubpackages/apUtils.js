...
function construOrder(params) {
    ...
    let header = proHead + proVersion + encryptTag + signTag + len + type + tag + time + deviceId + timeOut + sonDeviceId + msgType + deviceInfo + keep
