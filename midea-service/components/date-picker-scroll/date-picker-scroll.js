...
Component({
  ...
  methods: {
    initTime() {
      ...
      setTimeout(() => {
        this.setData({
          ...
          initValue: [years.length - 1, date.getMonth(), date.getDate() - 1],
        })
      }, 0)
    },
    //取消
    ...
    confirmBtn() {
      ...
      console.log('gggg', timeArr, years, months[timeArr[1]], days[timeArr[2]])
      let selectTime
      if (!timeArr.length) {
        //未滚动 点确定
        ...
        months[timeArr[1]] >= date.getMonth() + 1 &&
    ...
    fnbindChange(e) {
      ...
      console.log('KKKK', selYear, selMonth, selDay, date.getMonth() + 1)
      if (
