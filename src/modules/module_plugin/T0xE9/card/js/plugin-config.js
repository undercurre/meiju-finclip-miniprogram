...
export class PluginConfig {
  ...
  static apiKey = {
    ...
    weightLevel: 'weightLevel', // 面包重量
    burnColorLevel: 'burnColorLevel', // 烤色
    setWorkTime: 'workTime', // 工作时间
    appointTime: 'appointTime', // 预约
    feedingType: 'feedingType', // 投料
    isShowIngredient: 'isShowIngredient', // 是否显示食材详情
  }
