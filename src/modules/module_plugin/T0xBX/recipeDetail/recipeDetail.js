...
Page({
    ...
    oneButtonCooking() {
        ...
        if(this.data.deviceStatus.isAppointed) {
          this.showModal("预约中，暂不可操作")
          return
        }
