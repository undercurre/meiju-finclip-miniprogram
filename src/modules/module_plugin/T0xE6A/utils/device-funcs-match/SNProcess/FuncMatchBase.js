...
export default class FuncMatchBase {
  ...
  static calculateMajorDeviceType() {
    ...
    for (let j = 0; j < allFuncArrLength - 1; j++) {
      ...
      allFuncArr[maxIndex].extra = this.getFuncsInfoByIndexs(this.getDifferenceFunc(startChoice, allFuncArr[maxIndex]
        .funcIndex));
