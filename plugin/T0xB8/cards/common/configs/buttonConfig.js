...
isWorkState(deviceState, subDeviceState){
  ...
  let nonSubWrokState = ["default_sleeping","standing_sleeping","charge_pause_sleeping","return_station_pause_sleeping","dry_mop","hot_dry_mop","charging","charge_finish","erp_mode","cruise_pause_sleeping"]
