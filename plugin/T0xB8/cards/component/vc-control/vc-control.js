...
Component({
    ...
    methods: {
        updateCleanItem(DevStatus) {
            ...
            } else if (DevStatus.status == VC_WORK_STATE.workstate_recharging || DevStatus.status == VC_WORK_STATE.workstate_recharging_w11) {
        ...
        updateChargeItem(DevStatus) {
            ...
            if (DevStatus.status == VC_WORK_STATE.workstate_recharging|| DevStatus.status == VC_WORK_STATE.workstate_recharging_w11) {
                ...
                || DevStatus.status == VC_WORK_STATE.workstate_chargewithline||(DevStatus.subStatus==VC_WORK_STATE.workstate_recharging_w11 && DevStatus.status ==VC_WORK_STATE.workstate_on_base_w11)) {
